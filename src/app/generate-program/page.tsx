...
const GenerateProgramPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen text-foreground overflow-hidden  pb-6 pt-15">
      <div className="container mx-auto pl-90 mr-70 md:mr:92 h-full max-w-5xl ">
        {/* Title */}
